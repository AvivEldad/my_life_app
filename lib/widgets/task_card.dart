...
class TaskCard extends StatelessWidget {
  ...
  // כאשר true - המשימה נעולה (פרויקט טורי שעדיין לא הגיע תורה) ולא ניתן
  // לסמן אותה כהושלמה
  final bool locked;

  // אם מוגדר - יופעל במקום ההתנהגות הרגילה (taskService.deleteTask) לאחר
  // אישור המחיקה. משמש את מסך הפרויקט כדי לבדוק אם השלמת הפרויקט
  // הושגה בעקיפין (המשימה הפתוחה האחרונה נמחקה ולא סומנה).
                                ...
                                ? IconButton(
                                    ...
                                    onPressed: () {
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text(
                                            'המשימה נעולה - יש להשלים קודם את המשימות הקודמות בפרויקט',
                                ...
                                : Checkbox(
                                    ...
                                    onChanged: (bool? value) {
                                      ...
                                      if (isNowCompleted) {
                                        ...
                                        bool hasOpenSubTasks = task.subTasks
                                            .any(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // חיווי מאיזה פרויקט המשימה הגיעה (אם בכלל)
